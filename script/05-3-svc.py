...
def train_and_evaluate_model(df, feature, target, test_size=0.4, random_seed=400, num_iterations=99):
    ...
    for i in range(num_iterations):
        ...
        model = SVC(random_state=0,probability=True,class_weight='balanced',kernel='rbf', C=0.4,gamma = 0.15)
...
plt.title('Mean ROC Curve with SVC ')
plt.legend(loc='lower right')
plt.savefig("../result/SVC_ROC_bootstrap.pdf", format="pdf")
plt.savefig("../result/SVC_ROC_bootstrap.tiff", format="tiff")
plt.show()
...
plt.savefig("../result/SVC_upset.pdf", format="pdf")
plt.savefig("../result/SVC_upset.tiff", format="tiff")
plt.show()
...
plt.xlim((-0.05, 1.05))
plt.ylim((-0.05, 1.05))
plt.title('Mean PRC Curve with SVC')
plt.legend(loc='lower left')
plt.savefig("../result/SVC_PRC_bootstrap.pdf", format="pdf")
plt.savefig("../result/SVC_PRC_bootstrap.tiff", format="tiff")
plt.show()
