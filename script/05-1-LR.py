...
plt.title('Mean ROC Curve with LogisticRegression ')
plt.legend(loc='lower right')
plt.savefig("../result/LR_ROC_bootstrap.pdf", format="pdf")
plt.savefig("../result/LR_ROC_bootstrap.tiff", format="tiff")
plt.show()
...
plt.savefig("../result/LR_upset.pdf", format="pdf")
plt.savefig("../result/LR_upset.tiff", format="tiff")
plt.show()
...
plt.xlim((-0.05, 1.05))
plt.ylim((-0.05, 1.05))
plt.title('Mean PRC Curve with LogisticRegression')
plt.legend(loc='lower left')
plt.savefig("../result/LR_PRC_bootstrap.pdf", format="pdf")
plt.savefig("../result/LR_PRC_bootstrap.tiff", format="tiff")
plt.show()
