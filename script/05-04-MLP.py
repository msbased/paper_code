...
def train_and_evaluate_model(df, feature, target, test_size=0.4, random_seed=400, num_iterations=99):
    ...
    for i in range(num_iterations):
        ...
        model = MLPClassifier(random_state=0,hidden_layer_sizes = (8,6),max_iter=1000)
...
plt.title('Mean ROC Curve with MLP ')
plt.legend(loc='lower right')
plt.savefig("../result/MLP_ROC_bootstrap.pdf", format="pdf")
plt.savefig("../result/MLP_ROC_bootstrap.tiff", format="tiff")
plt.show()
...
plt.savefig("../result/MLP_upset.pdf", format="pdf")
plt.savefig("../result/MLP_upset.tiff", format="tiff")
plt.show()
...
plt.xlim((-0.05, 1.05))
plt.ylim((-0.05, 1.05))
plt.title('Mean PRC Curve with MLP')
plt.legend(loc='lower left')
plt.savefig("../result/MLP_PRC_bootstrap.pdf", format="pdf")
plt.savefig("../result/MLP_PRC_bootstrap.tiff", format="tiff")
plt.show()
